"""
Django project for project project.
...
For the full list of project and their values, see
...
# Quick-start development project - unsuitable for production
...
GITHUB_OAUTH_CALLBACK_URL = "http://localhost:8000/callback"
